...
def home_page():
    ...
    left_col.markdown(
        ...
        <a href="mailto:1155219137@link.cuhk.edu.hk">1155219137@link.cuhk.edu.hk</a></p>
        """,
    ...
    st.markdown(
        """
        ### About Me
        I am a recent master's graduate in Science of Marketing from the University of CUHK, eager to apply my knowledge and skills in a professional setting. During my academic journey, I developed a strong foundation in statistical analysis, machine learning, and data visualization.
